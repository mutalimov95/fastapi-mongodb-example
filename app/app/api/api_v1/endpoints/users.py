...
async def read_user_me(current_user: DBUser = Security(get_current_active_user),):
    """
    Get current user.
    """
    return current_user
...
def create_user_open(
    *, password: str = Body(...), email: EmailStr = Body(...),
):
    """
...
def read_user_by_id(
    user_id: str, current_user: DBUser = Depends(get_current_active_user),
):
    """
